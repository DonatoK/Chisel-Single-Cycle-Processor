...
object main  extends App {
 ...
 chisel3.Driver.emitVerilog(new fetch) //<:  new BRISC_V_Core)
}
...
class fetch extends Module {
  ...
  val out_addr = Wire(UInt(32.W))
  val instruction_address  = Wire(UInt(32.W))
  val PC_plus4 = Wire(UInt(20.W))
  val PC       = Wire(UInt(20.W))
...
val mem_interface0 = Module (new mem_interface())
  ...
  out_addr       := mem_interface0.io.out_address
  io.instruction := mem_interface0.io.out_data
