...
object main  extends App {
 ...
 chisel3.Driver.emitVerilog(new execute)
}
...
class execute extends Module {
  ...
  val ALU_Control = Wire(UInt(6.W))
  val ALU_branch  = Wire(UInt(1.W))
  val operand_A   = Wire(UInt(32.W))
  val operand_B   = Wire(UInt(32.W))
...
val ALU0 = Module (new ALU())
    ...
    io.zero       := ALU0.io.zero 
    ALU_branch    := ALU0.io.branch
    io.ALU_Result := ALU0.io.ALU_Result

//    ALU0.io.branch      := ALU_branch
//    ALU0.io.ALU_Result  := io.ALU_Result

io.JALR_target := ((io.regRead1 + io.extend) & "hfffffffe".asUInt(32.W))
}      
