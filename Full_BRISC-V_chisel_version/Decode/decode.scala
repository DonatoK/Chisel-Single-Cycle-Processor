...
object main  extends App {
 ...
 chisel3.Driver.emitVerilog(new decode) //<:  new BRISC_V_Core)
}
...
class decode extends Module {
  ...
  when(io.extend_sel === "b01".asUInt(2.W)){
    io.extend_imm := s_imm_32
  } .elsewhen (io.extend_sel === "b10".asUInt(2.W)){
  ...
  io.branch_target := io.PC + sb_imm_32
...
//registerfile
  val registerfile0 = Module(new register_file())
    ...
    io.rs1_data := registerfile0.io.read_data1
    io.rs2_data := registerfile0.io.read_data2
